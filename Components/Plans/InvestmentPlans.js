...
<Text style={styles.DescriptionStyle}><Text style={{fontWeight:"bold"}}>7: </Text>Invest in between 2k-50k {'->'} get 40% monthly profit {'->'} profit cycle is 10 days.</Text>
<Text style={styles.DescriptionStyle}><Text style={{fontWeight:"bold"}}>8: </Text>Invest in between 50k-100k {'->'} get 45% monthly profit {'->'} profit cycle is 15 days.</Text>
