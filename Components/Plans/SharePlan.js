...
<Text style={styles.DescriptionStyle}><Text style={{fontWeight:"bold"}}>5: </Text>Once total of your 5 refers invest in any package your level 1 will be unlocked and you will get <Text style={{color:Colors.PrimaryColor}}>1,500 Rs</Text> as reward.</Text>
<Text style={styles.DescriptionStyle}><Text style={{fontWeight:"bold"}}>6: </Text>Once total of your 20 refers invest in any package your level 2 will be unlocked and you will get <Text style={{color:Colors.PrimaryColor}}>6,000 Rs</Text> as reward.</Text>
<Text style={styles.DescriptionStyle}><Text style={{fontWeight:"bold"}}>7: </Text>Once total of your 30 refers invest in any package your level 3 will be unlocked and you will get <Text style={{color:Colors.PrimaryColor}}>8,500 Rs</Text> as reward.</Text>
